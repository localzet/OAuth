...
use LIS\Exception\InvalidApplicationCredentialsException;
use LIS\Exception\InvalidAuthorizationStateException;
use LIS\Exception\InvalidAuthorizationCodeException;
use LIS\Exception\AuthorizationDeniedException;
use LIS\Exception\InvalidAccessTokenException;
use LIS\Data;
use LIS\HttpClient;
...
class OAuth2 extends AbstractAdapter implements AdapterInterface
{
     ...
     *
     * @throws \LIS\Exception\InvalidAuthorizationCodeException
     * @throws \LIS\Exception\AuthorizationDeniedException
     */
     ...
     *
     * @throws \LIS\Exception\HttpClientFailureException
     * @throws \LIS\Exception\HttpRequestFailedException
     ...
     * RFC6749 and OAuth specifications, LIS will consider any HTTP
