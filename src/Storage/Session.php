...
use LIS\Exception\RuntimeException;
...
class Session implements StorageInterface
{
     ...
     * @var string
     */
    protected $storeNamespace = 'LIS::STORAGE';
    ...
    public function __construct()
    {
        ...
        if (headers_sent()) {
            // phpcs:ignore
            throw new RuntimeException('HTTP headers already sent to browser and LIS won\'t be able to start/resume PHP session. To resolve this, session_start() must be called before outputing any data.');
        }
