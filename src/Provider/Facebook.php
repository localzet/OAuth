 ...
 *   ];
 *
 *   $adapter = new LIS\Provider\Facebook($config);
 *
 *   try {
 ...
 *       $response = $adapter->setUserStatus("LIS test message..");
 *   } catch (\Exception $e) {
 *       echo $e->getMessage() ;
 *   }
 */
class Facebook extends OAuth2
{
     ...
     * @throws \LIS\Exception\InvalidAccessTokenException
     */
