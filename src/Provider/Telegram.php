...
use LIS\HttpClient\Util;
use LIS\Data\Collection;
use LIS\User\Profile;
use LIS\Adapter\AbstractAdapter;
use LIS\Adapter\AdapterInterface;
 ...
 *   ];
 *
 *   $adapter = new LIS\Provider\Telegram($config);
 *
 *   try {
